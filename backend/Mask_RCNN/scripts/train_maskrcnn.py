...
def get_model(num_classes, device):
    ...
    """
    # Sprawdzenie dostępności wag pretrenowanych
    ...
    # Dostosowanie głowic do nowej liczby klas
    ...
    # Przeniesienie modelu na docelowe urządzenie
    model.to(device)
...
def train_model(args, is_api_call=False):
    ...
    Implementuje pełen cykl treningu, w tym:
    ...
    try:
        ...
        # Diagnostyka pamięci współdzielonej
        shm_path = "/dev/shm"
    ...
    # Sprawdzenie istnienia plików adnotacji
    ...
    if resume_path and os.path.exists(resume_path):
        try:
            ...
            if isinstance(checkpoint, dict) and 'model_state_dict' in checkpoint:
                # Wczytanie stanu modelu i parametrów treningu
                ...
                # Reset learning rate do wartości z argumentu
        ...
        with tqdm(total=end_epoch - start_epoch + 1, desc="Trening", unit="epoka", file=sys.stdout) as pbar:
            for epoch in range(start_epoch, end_epoch + 1):
                ...
                if strata_walidacyjna < najlepsza_strata_walidacyjna:
                    ...
                    # Zapisanie najlepszego checkpointu
                    checkpoint = {
                    ...
                    # Inkrementacja licznika early stopping
